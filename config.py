...
def get_args() -> dict:
    ...
    # path
    parser.add_argument('--inputs_path', type=str, default='/home/HBVtosoil/')
    ...
    parser.add_argument('--input_size', type=float, default=17)
    parser.add_argument('--num_layers', type=float, default=4)
    ...
    parser.add_argument('--niter', type=float, default=600) #200
